...
report_label = ['Plot 58 Rating Curves (Minor to Major Flood Flows) - Sheet 1 of 3',
                'Plot 59 Rating Curves (Minor to Major Flood Flows) - Sheet 2 of 3',
                'Plot 60 Rating Curves (Minor to Major Flood Flows) - Sheet 3 of 3',
                'Plot 61 Rating Curves (Minor to Extreme Flood Flows) - Sheet 1 of 3',
                'Plot 62 Rating Curves (Minor to Extreme Flood Flows) - Sheet 2 of 3',
                'Plot 63 Rating Curves (Minor to Extreme Flood Flows) - Sheet 3 of 3']

fig_name = ['Plot 058 Rating Curves (Minor to Major Flood Flows) - Sheet 1 of 3',
            'Plot 059 Rating Curves (Minor to Major Flood Flows) - Sheet 2 of 3',
            'Plot 060 Rating Curves (Minor to Major Flood Flows) - Sheet 3 of 3',
            'Plot 061 Rating Curves (Minor to Major Flood Flows) - Sheet 1 of 3',
            'Plot 062 Rating Curves (Minor to Major Flood Flows) - Sheet 2 of 3',
            'Plot 063 Rating Curves (Minor to Major Flood Flows) - Sheet 3 of 3']



foot_note ='Fast Model Version 0285\nDetailed Model version 605'
loc_file =[l_file,l_file,l_file,ex_l_file,ex_l_file,ex_l_file]
result_indices = [[1,0,6,7],[3,4,5,2],[8,9,8,9],[1,0,6,7],[3,4,5,2],[8,9,8,9]]
